...
echo "[05/13] Module preservation..."
$PIXI R/05b_module_preservation.R

echo "[05/13] Module preservation diagnostics..."
$PIXI R/diagnose_mp.R
...
echo "[13/14] Sensitivity analyses all..."
$PIXI R/14_sensitivity_analyses_covariates.R
